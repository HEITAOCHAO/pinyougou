			...
			<div class="product-info">
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<#if (imgList?size>0)>
							<span class="jqzoom"><img jqimg="${imgList[0].url}" src="${imgList[0].url}" style="width:400px;height:400px"/></span>
						</#if>
						</div>
						<!--下方的缩略图-->
						...
						<#list specList as spec>
							<dl>
								...
								<#list spec.attributeValue as value>
									<dd><a href="javascript:;"  class="{{isSelect('${spec.attributeName}','${value}')?'selected':''}}"  ng-click="selectSpec('${spec.attributeName}','${value}')" >${value}<span title="点击取消选择">&nbsp;</span></a></dd>
								</#list>
							</dl>					
						</#list>
						</#if>
